					...
					<div class="layui-table-box">
						...
						<div class="layui-table-body layui-table-main color-data pageTable" name="color-data">
							<table cellspacing="0" cellpadding="0" border="0"
								class="layui-table">
								<tbody>
									<tr v-bind:data-id="c.id" v-bind:data-index="index" class="" v-for="(c, index) in color">
										<td class="item code">
										...
										<td class="item useflag">
											<div class="layui-table-cell laytable-cell-1-0-2">
												<i class="layui-icon layui-icon-ok" v-if="c.useflag == 1"></i>
											</div>
										</td>
										<td class="item creator">
											<div class="layui-table-cell laytable-cell-1-0-3">{{c.creator}}</div>
										</td>
										<td class="item createtime time-item">
											<div class="layui-table-cell laytable-cell-1-0-3">{{formatDate(c.createtime)}}</div>
										</td>
