 ...
 */
@Service
public class VipDepositRecordServiceImpl implements IVipDepositRecordService, Serializable {
...
private static final long serialVersionUID = 71148004875517941L;
	...
	public Result queryVipDepositRecordByOpenid(String appid, String openid, PagingView page) {
		...
		try {
			...
			FastLog.error("调用VipDepositRecordServiceImpl.queryVipDepositRecordByOpenid报错：", e);
		}
